...
passport.use(new OAuth2CustomStrategy({
  authorizationURL: config.ncHost + '/apps/hedgenext/oauth/authorize',
  tokenURL: config.ncHost + '/apps/hedgenext/oauth/tokenget',
  clientID: 'hedgenext',
  clientSecret: config.ncSecret,
  callbackURL: config.serverURL + '/auth/oauth2/callback',
  userProfileURL: config.ncHost + '/apps/hedgenext/oauth/userdataget',
  scope: undefined,
  state: true
