...
module.exports = {
  ...
  gotenbergPDF: process.env.GOTENBERG_PDF,
  ncUser: process.env.NC_USER,
  ncPassword: process.env.NC_PASSWORD,
  ncFolder: process.env.NC_FOLDER,
  ncHost: process.env.NC_HOST,
  ncSecret: process.env.NC_SECRET,
